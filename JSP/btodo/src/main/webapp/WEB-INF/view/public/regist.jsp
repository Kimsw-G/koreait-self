...
<form action="/member/regist" method="post" id="wrapper">
	...
	<%-- <button>중복체크</button> --%>
	<strong>비밀번호</strong>
	<input type="password" placeholder="비밀번호" name="pw" id="pw"required><br>
	<input type="password" placeholder="비밀번호 체크" name="pwck" id="pwck"required><br>
	<strong>이름</strong>
	<input type="text" placeholder="이름" name="name" id="name"required><br>
	<strong>전화번호</strong><br>
	<div id="tel">
	<%-- 첫 박스는 드롭다운으로 구현 --%>
		<input type="text" name="tel" id="tel_1"required> 
		<input type="text" name="tel" id="tel_2"required>
	</div>
